...
p.modus_ponens(p.specialise(Thm_2_4, (a,b,a1,b1)))
B5 = p.modus_ponens(p.specialise(Thm_2_5, (b,a,a1,b1)))
...
p.modus_ponens(p.specialise(Thm_2_4, (c,a,c1,a1)))
D4 = p.modus_ponens(p.specialise(Thm_2_5, (a,c,c1,a1)))
